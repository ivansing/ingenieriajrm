<?php
  ...
  //Delete Category
   if(isset($_GET['delete']) && !empty($_GET['delete'])){
     ...
     if($category['parent'] == 0){ // deletes whole parent and child category
  ...
  <div class="row">
    ...
    <div class="col-md-6">
      <form class="form" action="categories.php<?=((isset($_GET['edit']))?'?edit='.$edit_id:'');?>" method="post">
        ...
        <div id="errors"></div> <!-- will show errors array using jQuery-->
        <div class="form-group">
          <label for="parent">Parent</label>
          <select class="form-control" name="parent" id="parent">
            <option value="0"<?=(($parent_value == 0)?' selected="selected"':'');?>>Parent</option> <!-- value is 0 because is the parent -->
        ...
        <tbody>
          <?php
            ...
            while($parent = mysqli_fetch_assoc($result)):
                $parent_id = (int)$parent['id']; // put int so just integers
