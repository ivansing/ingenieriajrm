<?php
  ...
  if(isset($_POST['add_submit'])){
    ...
    $result = $db->query($sql);
    $count = mysqli_num_rows($result); // will tell how many rows
    if($count > 0){
...
<div class="text-center">
  <form class="form-inline" action="brands.php<?=((isset($_GET['edit']))?'?edit='.$edit_id:'');?>" method="post">
    <div class="form-group">
      ...
      <input type="text" name="brand" id="brand" class="form-control" value="<?=$brand_value; ?>"><!--it will keep the post value -->
