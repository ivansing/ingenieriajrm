...
if(isset($_GET['add']) || isset($_GET['edit'])){
  ...
  $sizes = rtrim($sizes,','); // this is to get of rid of the last comma
  $saved_image = '';
...
if($_POST){
  $errors = array();
  //Validation to submit add product
  ...
  if($_FILES['photo']['name'] != ''){
   ...
   $dbpath = '/ecommerce2/images/products/'.$uploadName;
   if($mimeType != 'image'){
  ...
  if(!empty($errors)){
    ...
    //Insert all data product to the database
...
?>
  ...
  <form action="products.php?<?=((isset($_GET['edit']))?'edit='.$edit_id:'add=1');?>" method="post" enctype="multipart/form-data"><!--multiform data is to upload files-->
    ...
    <div class="form-group col-md-3">
      ...
      <input name="list_price" class="form-control" id="price" name="price" value="<?=$list_price;?>">
    </div>
    ...
    <?php if($saved_image != '') : ?>
      <div class="saved_image">
        <img src="<?=$saved_image;?>" alt="saved_image" width="200px" height="auto"/><br>
        <a href="products.php?delete_image=1&edit=<?=$edit_id;?>" class="text-danger">Delete Image</a>
      </div>
    <?php else: ?> <!-- Not to choose image in the add product page -->
